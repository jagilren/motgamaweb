# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'reports/reporte_operaciones_de_albaran.xml',

        'reports/reporte_tipo_transaccion.xml',
        'views/reporte_tipo_transaccion.xml',
        'reports/reporte_tipo_transaccion_documento.xml',
        'views/reporte_tipo_transaccion_documento.xml'
        ]
}